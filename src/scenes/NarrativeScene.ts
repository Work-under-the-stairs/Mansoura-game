...
export class NarrativeScene {
  ...
  private readonly secondText = "بسم الله الرحمن الرحيم نجحت قواتنا المسلحة في عبور قناة السويس على طول المواجهة وتم الاستيلاء على منطقة الشاطئ الشرقي للقناة وتواصل قواتنا حاليا قتالها مع العدو بنجاح كما قامت قواتنا البحرية بحماية الجانب الايسر لقواتنا على ساحل البحر الابيض المتوسط وقد قامت بضرب الاهداف الهامة للعدو.";
