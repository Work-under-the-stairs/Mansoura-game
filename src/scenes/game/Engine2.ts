...
import { EnemyManager } from './EnemyManager2'; // Updated import to EnemyManager2
...
export class Engine {
  ...
  private transitionPlane: TransitionPlane;
  ...
  constructor(loadingScene: LoadingScene) {
    ...
    // TransitionPlane integration
    this.transitionPlane = new TransitionPlane(
        this.scene,
        this.loadingManager,
        this.cockpit.model
    );

    // EnemyManager integration (using EnemyManager2 with 21-enemy staggered logic)
