...
class HealthSystem {
  ...
  <style>
    ...
    #cs-death-card{
      ...
      box-shadow:
        ...
        inset 0 0 30px rgba(255,0,0,.05);
      padding:32px;
      text-align:center;
      position:relative;
      overflow:hidden;
  ...
  <div id="cs-hull-hud">
    ...
    <div id="cs-hp-pct-wrap">
      <span id="cs-hp-pct">100%</span>
    </div>
  </div>
  ...
  <div id="cs-death">
    <div id="cs-death-card">
      ...
      <div id="cs-death-sub">
        AIRFRAME LOST • PILOT EJECT REQUIRED
      </div>

      <button id="cs-btn-retry">
        ↺ REDEPLOY MISSION
      </button>
...
export class CombatSystem {
  ...
  type: 'warn',
  title: 'إصابة بصاروخ',
  msg: 'صاروخ معادٍ أصاب الطائرة. تم رصد أضرار هيكلية.',
  duration: 3000,
});
      }
    }
