...
export class MissionController2 {
  ...
  // FIX: Detect mobile once and reuse — avoids repeated UA string parsing
  ...
  private addVictoryConfetti(): void {
    ...
    // FIX: Cap confetti count on mobile — 80 animated DOM elements causes UI-thread freeze
    // on low-end Android/iOS. 30 is visually sufficient and safe.
    const count = this.isMobile ? 30 : 80;
